...
public class SwingGraphics2dRendererSolaPlatform extends AbstractSolaPlatformRework {
  ...
  protected Renderer buildRenderer(SolaConfiguration solaConfiguration) {
    return new Graphics2dRenderer(graphics2D, solaConfiguration.getCanvasWidth(), solaConfiguration.getCanvasHeight());
  }
}
