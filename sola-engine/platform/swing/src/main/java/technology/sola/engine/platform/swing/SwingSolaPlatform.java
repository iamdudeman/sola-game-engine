...
public class SwingSolaPlatform extends SolaPlatform {
  ...
  private void setupSoftwareRendering(SolaConfiguration solaConfiguration) {
    ...
    onRender = renderer -> {
      ...
      graphics.clearRect(aspectRatioSizing.x(), aspectRatioSizing.y(), aspectRatioSizing.width(), aspectRatioSizing.height());
  ...
  private void setupGraphics2dRendering() {
    ...
    beforeRender = renderer -> {
      ...
      AspectRatioSizing aspectRatioSizing = viewport.getAspectRatioSizing();
      graphics2D.clearRect(aspectRatioSizing.x(), aspectRatioSizing.y(), aspectRatioSizing.width(), aspectRatioSizing.height());
