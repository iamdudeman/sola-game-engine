 ...
 */
@NullMarked
public class SwingWavAudioClip implements AudioClip {
   ...
   */
  public SwingWavAudioClip(Clip clip, AudioInputStream audioInputStream) throws IOException, LineUnavailableException {
    this.clip = clip;
