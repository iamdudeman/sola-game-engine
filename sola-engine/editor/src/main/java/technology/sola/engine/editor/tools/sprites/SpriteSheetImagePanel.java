...
/**
 * SpritesImagePanel is an {@link EditorPanel} for viewing a sprites asset's rasterized image and interacting with it.
 */
class SpriteSheetImagePanel extends EditorPanel {
  /**
   * Creates an instance for desire image {@link File}
   *
   * @param imageFile the image file
   */
  public SpriteSheetImagePanel(File imageFile) {
