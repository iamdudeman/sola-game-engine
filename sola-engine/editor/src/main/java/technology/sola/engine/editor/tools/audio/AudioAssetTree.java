...
import technology.sola.engine.editor.tools.font.NewFontDialogContent;
...
class AudioAssetTree extends VBox {
  ...
  private record FontAssetActionConfiguration(
    ...
    public void create(File parentFolder, Runnable onAfterCreate) {
      DialogService.custom("New Font", new NewAudioDialogContent(parentFolder, onAfterCreate));
    }
